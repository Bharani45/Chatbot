...
// New event handler to populate the initial customer list
socket.on("customerList", (customerList) => {
  customerList.forEach(({ id, message }) => {
    if (!customerData[id]) {
      ...
      // You may need to append the first message here if you store it on the server
      if(message) {
